      ...
      <div className="wrap">
        <div className="footer__grid">
          ...
          <div>
            ...
            <ul>
              {SERVICES.map((s) => (
                <li key={s}><Link to="/servicios">{s}</Link></li>
              ))}
            </ul>
          </div>
          <div>
            <h5>Contacto</h5>
            <ul>
              <li><a href={WA} target="_blank" rel="noopener">{TEL}</a></li>
            ...
            <div className="footer__social" style={{ marginTop: 20 }}>
              ...
              <a href={`mailto:${MAIL}`} aria-label="Email">
                <svg viewBox="0 0 24 24"><path d="M3 5h18a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zm9 7.5L20 7H4zm0 2L4.2 8.8V18h15.6V8.8z" /></svg>
              </a>
            </div>
          </div>
        </div>
        <div className="footer__bottom">
          <span>© {new Date().getFullYear()} Lorena Macías · Arquitecta. Todos los derechos reservados.</span>
